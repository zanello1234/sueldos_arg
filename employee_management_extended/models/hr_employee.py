...
class EmployeeExtended(models.Model):
    ...
    marca_cct = fields.Boolean(string="Marca CCT", help="Indica si el empleado está bajo un convenio colectivo de trabajo.")
    svo = fields.Boolean(string="SVO", help="Indica si el empleado está bajo el sistema de viáticos obligatorios.")
    corresponde_reduccion = fields.Boolean(string="Corresponde Reducción", help="Indica si al empleado le corresponde una reducción.")
